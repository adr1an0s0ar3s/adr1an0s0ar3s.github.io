...
export default function HeaderDropdown({ label, options }) {
    ...
    return (
        <div ref={ref} className="relative">
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2 z-10 mt-3 w-screen max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl xl:max-w-3xl overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5" hidden={!expand}>
